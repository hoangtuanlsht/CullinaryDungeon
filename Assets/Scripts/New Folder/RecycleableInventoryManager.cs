...
public class RecycleableInventoryManager : MonoBehaviour, IRecyclableScrollRectDataSource
{
    ...
    public void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.B))
        {
            ...
            Vector3 posInvent = inventoryGameObject.GetComponent<RectTransform>().anchoredPosition;
            inventoryGameObject.GetComponent<RectTransform>().anchoredPosition = posInvent.y == 1000 ? Vector3.zero: new Vector3(600,1000,0);
        }
    }
